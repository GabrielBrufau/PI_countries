...
- esto ya deberia conectar y correr normal en las rutas :D* 

# frondend

- in fullStackApp/frondend `touch Dockerfile .dockerignore package.json src public`
in fullStackApp/frondend/package.json
```json
{
  "name": "frond",
  "version": "0.1.0",
...
```
in fullStackApp/frondend/Dockfile
```docker
FROM node:14-slim
...
in fullStackApp/docker-compose.yml
```yml
version: "3"
